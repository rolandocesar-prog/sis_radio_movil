	...
	<head>
		...
		<script type="text/javascript">
			function validar() {
				...
				ventanaCalendario = window.open("rpt_llamadas_fecha_tipo1.php?fecha1=" + fecha1 + "&fecha2=" +fecha2+ "&descripcion=" +descripcion , "calendario" , "width=600, height=550,left=100,top=100,scrollbars=yes,menubars=NO,statusbar=NO,status=NO,rezizable=YES,location=NO")
			}
		</script>
		{/literal}
	</head>
