...
$movil_asignado = $_REQUEST["num_movil"];
...
$sql = $db->Prepare("SELECT *
					FROM clientes c, tipo_llamada t, llamadas l, tipos_moviles m
 					...
 					ORDER BY l.fec_insercion ASC
 					");
$rs = $db->GetAll($sql, array($fecha1, $fecha2, $movil_asignado));

$fecha = date("Y-m-d H:i:s");
$smarty->assign("llamadas_movil1", $rs);
$smarty->assign("fecha", $fecha);
$smarty->assign("direc_css", $direc_css);
$smarty->display("rpt_llamadas_movil1.tpl");
?>