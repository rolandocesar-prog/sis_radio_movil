...
<body class="fondo">
	<center>
		...
		<br>
		<form action="zona_modificar1.php" method="post" name="formu">
			<table border="1" class="listado">
				{foreach item=r from=$zona}
				<tr>
					<th align="right">Zona (*)</th><th>:</th>
					<td><input type="text" name="zona" onkeyup="this.value=this.value.toUpperCase()" value="{$r.zona}">  </td>
				</tr>
				<tr>
